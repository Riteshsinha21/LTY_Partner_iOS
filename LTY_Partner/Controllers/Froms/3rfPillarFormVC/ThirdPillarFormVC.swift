...
class ThirdPillarFormVC: UIViewController {
    ...
    @IBOutlet weak var lblTitleDiscription: UILabel!
    @IBOutlet weak var lblHowMuchToInsure: UILabel!
    @IBOutlet weak var titleHowMuchToInsure: UILabel!
    ...
    func setLocalization(){
        ...
        self.lblTitleDiscription.text = "Description".localized()
        self.lblTitlePersnalInfo.text = "Personal Information".localized()
        self.lblTitlePersnalInfoFullName.text = "Full Name".localized()
        self.titleHowMuchToInsure.text = "How much do you want to insure ?".localized()
        ...
        if data.status == "SUCCESS"{
            DispatchQueue.main.async {
               ...
               // self.lblPersnalInfoMobile.text = persnalInfo?.mobile  ?? ""
                ...
                self.lblInjured.text =  metaData?.areYourDetailsDifferent ?? ""
                self.lblHowMuchToInsure.text =  metaData?.howMuchYouWantToInsure ?? ""
                ...
                if (self.lblSituation.text!.caseInsensitiveCompare("Other".localized()) == .orderedSame)  {
                    self.discriptionView.isHidden = false
                    self.lblDiscription.text = metaData?.professionalSituationDescription ?? ""
                }else{
                ...
                self.lblStreetAddress.text =  responseData?.address ?? ""
