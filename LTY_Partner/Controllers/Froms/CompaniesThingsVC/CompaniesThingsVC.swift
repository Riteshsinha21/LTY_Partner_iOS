...
//                self.lblStreetNo.text = companyData?.effectiveDate ?? ""
                ...
                self.lblStartContract.text = returnDOB(date:companyData?.startOfContract ?? "")
                self.lblEffectiveDate.text = returnDOB(date:companyData?.effectiveDate ?? "")
                ...
                self.lblExpiryDate.text =  returnDOB(date:companyPropertyData?.expiryDate ?? "")
