...
// MarK:- Title Outlets
    ...
    @IBOutlet weak var lblTitleCompName: UILabel!
    
    @IBOutlet weak var lblCompName: UILabel!
    
    @IBOutlet weak var effectiveDtLbl: UILabel!
    @IBOutlet weak var durationLbl: UILabel!
    @IBOutlet weak var titleEffectiveDtLbl: UILabel!
    @IBOutlet weak var titleDurationLbl: UILabel!

    @IBOutlet weak var lblTitleHeatingSysDesc: UILabel!
    @IBOutlet weak var lblHeatingSysDesc: UILabel!
    @IBOutlet weak var lblTitleBuildingTypeDesc: UILabel!
    @IBOutlet weak var lblBuildingTypeSysDesc: UILabel!
    ...
    func setLocalization () {
        ...
        self.lblTitleCompName.text = "Company Name/Policy Number".localized()
        self.lblHeatingSysDesc.text = "Heating System Description".localized()
        self.lblBuildingTypeSysDesc.text = "Building Type Description".localized()
        ...
        self.titleEffectiveDtLbl.text = "Effective Date".localized()
        ...
        self.titleBenefitsLbl.text = "Benefits".localized()
        ...
        self.titlePastInsured.text = "Are you or were you in the past insured for the branches offered?".localized()
        ...
        if data.status == "SUCCESS"{
            DispatchQueue.main.async {
              ...
              //  self.lblPersnalInfoMobile.text = persnalInfo?.mobile  ?? ""
                ...
                self.effectiveDtLbl.text = returnDOB(date: data.data?.metadata?.personalDetails.effectiveDate ?? "")
                ...
                self.fullNmae.text = basicInfoTitle + " " + fname + " " + lname
...
//                self.phoneLbl.text = basicInfo?.mobile  ?? ""
                ...
                self.lblYearConstruction.text = returnDOB(date: data.data?.metadata?.yearOfConstruction ?? "")
                
                
                self.buildingTypeLbl.text = data.data?.metadata?.buildingType ?? ""
                
                self.lblHeatingSysDesc.text = data.data?.metadata?.heatingSystemDescriptions ?? ""
                self.lblBuildingTypeSysDesc.text = data.data?.metadata?.buildingTypeDescription ?? ""
...
//                self.reason.text = data.data?.metadata?.reason ?? ""
                self.reason.text = data.data?.metadata?.anyClaims ?? ""
                if (self.reason.text!.caseInsensitiveCompare("yes".localized()) == .orderedSame) {
                    self.clameDamageView.isHidden = false
                    self.lblClaimDamage.text = data.data?.metadata?.claimDetails ?? ""
                ...
                if   (self.pastInsured.text!.caseInsensitiveCompare("yes".localized()) == .orderedSame) {
                    self.reasonOfConstructionView.isHidden = true
                    ...
                    self.claimDetails.text = data.data?.metadata?.reason ?? ""
                    self.companyPolicyView.isHidden = true
                }
            }
        }else{
