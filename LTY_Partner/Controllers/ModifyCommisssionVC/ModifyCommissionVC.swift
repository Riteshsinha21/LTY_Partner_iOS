...
class ModifyCommissionVC: UIViewController, ModifyCommissionProtocolDelegate ,UITextFieldDelegate{
    ...
    @IBOutlet weak var companyReserveTxt: UITextField!
    @IBOutlet weak var adminCommissionTxt: UITextField!
    ...
    func setData() {
        ...
        self.adminCommissionTxt.text = "\(self.contractDic?.commissionDetails?.adminCommission ?? 0.0)"
        self.companyReserveTxt.text = "\(self.contractDic?.commissionDetails?.companyReserve ?? 0.0)"
    ...
    @IBAction func onClickAdd(_ sender: UIButton) {
        ...
        commissionDic.setValue(self.agentGrossTxt.text!, forKey: "adminCommission")
        commissionDic.setValue(self.agentGrossTxt.text!, forKey: "companyReserve")
