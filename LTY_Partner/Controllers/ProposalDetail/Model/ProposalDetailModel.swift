...
struct commissionDataClass: Codable {
    let partnerCommission, partnerReserve, partnerGrossCommission, agentCommission, adminCommission, companyReserve: Double?
...
struct ViewProposalData:Codable {
    ...
    let signedDoc: [policyDocDetails]?
    let contractDoc: [policyDocDetails]?
    let isDeleted: Bool?
...
struct ViewProposalCommissionDetails:Codable {
    let partnerCommission, partnerReserve, partnerGrossCommission, agentCommission, companyReserve, adminCommission: Double?
    let agentReserve, agentGrossCommission: Double?
...
struct ViewProposalPolicyDetails:Codable {
    ...
    let policyDocs: [policyDocDetails]?
