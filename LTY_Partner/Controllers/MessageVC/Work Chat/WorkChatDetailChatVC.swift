...
class WorkChatDetailChatVC: UIViewController, UIGestureRecognizerDelegate, ShowImageViewProtocolDelegate {
    func showImage(data: ShowImageModel) {
        DispatchQueue.main.async {

            self.receiverProfileImgView.sd_setImage(with:URL(string: data.data?.preSignedUrl ?? ""), placeholderImage:UIImage(named: "user"))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let param : [String:Any] = ["key":senerImage ]
