...
//        categoryViewModel.productCommissionListApi(param: param, url: LTY_END_POINT_URL.getCategory)
    ...
    func setData() {
        ...
        if result[0] as! String == "fr" {
            self.categoryNameInFrench = catDetails["categoryNameInFrench"] as? String ?? ""
            self.subCategoryNameInFrench = catDetails["subCategoryNameInFrench"] as? String ?? ""
            ...
            self.categoryName = catDetails["categoryName"] as? String ?? ""
            self.subCategoryName = catDetails["subCategoryName"] as? String ?? ""
            self.categoryTxt.text = catDetails["categoryName"] as? String
            self.subCategoryTxt.text = catDetails["subCategoryName"] as? String
        }
        self.categoryLogo = catDetails["categoryLogo"] as? String ?? ""
            ...
            for cat in categoryListNewData{
                ...
                let action = UIAlertAction(title: cat.categoryNameInFrench, style: .default) { (action) in
                    ...
                    if shouldEditMembers {
                        ...
                        self.catDic.setValue("", forKey: "categoryLogo")
...
//              action.setValue(icon, forKey: "image")
    ...
    @IBAction func onClickNext(_ sender: Any) {
        ...
        self.catDic.setValue(self.categoryLogo, forKey: "categoryLogo")
