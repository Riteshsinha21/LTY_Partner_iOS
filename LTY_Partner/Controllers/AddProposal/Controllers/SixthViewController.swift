...
//                    dic.setValue(OriginalFileName, forKey: "url")
...
extension SixthViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let info = self.policyDocsArr[indexPath.row] as! policyDocDetails
        let key = info.key!
        cell.cellImg.sd_setImage(with: URL(string: key), placeholderImage: UIImage(named: "docs"))
...
//         let filename: NSString = policyDocsDic[indexPath.row] as! NSString
        let info = policyDocsArr[indexPath.row] as! policyDocDetails
        ...
        if pathExtention == "pdf" || pathExtention == "docx" || pathExtention == "doc"{
            ...
            let info = policyDocsArr[indexPath.row] as! policyDocDetails
            vc.attachmentStr = info.key as! String
