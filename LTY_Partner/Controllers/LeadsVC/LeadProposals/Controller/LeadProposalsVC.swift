...
protocol updateLeadListApiProtocol{
...
class LeadProposalsVC: UIViewController {
    ...
    var updateLeadListApiDelegate: updateLeadListApiProtocol?
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        self.updateLeadListApiDelegate?.callApiFunc(setValue: self.isUpdatedLeadList)
    }
