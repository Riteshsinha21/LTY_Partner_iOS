...
struct LeadInsuranceMemberDetails:Codable {
    let memberId,  title, firstName, lastName, email: String?
...
struct TravelMemberDetails :Codable{
    let memberId, familyMemberId, title, firstName, lastName: String?
...
struct TravelMetadata :Codable{
    let type: String?
    let personsToBeInsured: String?
    let adultsCount, childrenCount: Int?
...
struct BuildingMetadata :Codable{
    ...
    let type: String?
    let buildingType, buildingTypeDescription, heatingSystemDescriptions, securityMeasures, heatingSystem, sumInsured: String?
...
struct ThirdPillarMetadata : Codable{
    ...
    let professionalSituation, professionalSituationDescription, job, areYourDetailsDifferent: String?
}
...
struct AnimalMetadata :Codable{
    ...
    let startOfInsurance, startDate, insuredAnimal, gender, breed: String?
    let petsName, dob, color, electronicChipNo, confirmation: String?
...
struct HouseHoldRCMetadata :Codable {
    ...
    let placeOfRisk, sumInsured, typeOfConstruction, placeOfRiskDescription: String?
    let benefits: [String]?
...
struct TenantDetails :Codable {
    ...
    let isOtherPersonAvailable: Bool?
...
struct QuatationMetadata :Codable {
    ...
    let supportingDoc: policyDocDetails?
    let benefits: [String]?
...
struct MotorVehicleMetadata: Codable {
    ...
    let otherDriversOutsideCommonHousehold, anyDriversWithProvisionalLicense, haveGrayCard: String?
    let attachCard:policyDocDetails?
    let vehicleDetails: MotorVehicleVehicleDetails?
    let isSecondVehicleInsured, secondVehicleHaveGrayCard: String?
    let attachSecondVehicleCard: policyDocDetails?
    ...
    let policyReplacedByAnotherCompany, insuranceCompany, licenceWithdrawn: String?
    ...
    let replacementVehicleRental, partialCasco, personalEffects, personalEffectsValue, cascoIntegral, collisionDeductible: String?
    let occupantProtection, waiverOfRecourse, remarks, breakdownService: String?
}

// MARK: - DriverInfo
struct MotorVehicleDriverInfo: Codable {
    let name, contactNumber, address, nationality, dob: String?
}
...
struct MotorVehicleSufferedDamageDetails: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case sufferedDamageDetailsIn = "in"
        case date = "date"
        case amount = "amount"
...
struct MotorVehicleTrafficAccidentDetails: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case trafficAccidentDetailsIn = "in"
        case date = "date"
        case amount = "amount"
    ...
    init(from decoder: Decoder) throws {
            ...
            self.trafficAccidentDetailsIn = try container.decodeIfPresent(String.self, forKey: .trafficAccidentDetailsIn) ?? ""
...
struct ConstructionMetadata: Codable {
    ...
    let typeOfConstruction, typeOfConstructionDescription: String?
    let projectAddressDetails: ConstructionProjectAddressDetails?
    let areTheWorkAccepted, hasWorkStarted, knownLoss: String?
    let architectDetails: ConstructionDetails?
    let civilEngineerDetails: CivilEngineerDetails?
    let masterOfWorkFor, masterOfWorkDescription: String?
    ...
    let changesToStructure, roofWork, dangerZone,specify, conditionOfThirdPartyWork: String?
    let statutoryCivilLiability: String?
    let agreement, maps, quotation, reports: policyDocDetails?
    let requirements, why: String?
    let notes, date, place: String?
}

// MARK: - Details
struct ConstructionDetails: Codable {
    let name, email, countryCode, phone, address: String?
}
struct CivilEngineerDetails: Codable {
    let name, email, countryCode, phone, address: String?
}
