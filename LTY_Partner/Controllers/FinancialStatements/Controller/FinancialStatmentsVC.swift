...
class FinancialStatmentsVC: UIViewController, UITextFieldDelegate {
  ...
  //MARK:- Api call func
    ...
    func ApiCallingFunc(state:String) {
        ...
        print(param)
        proposalVM.proposalListApi(param: param, showLoader: true)
    }
    ...
    @IBAction func onClickSearch(_ sender: UIButton) {
        ...
        let vc = FinancialFilterVC.instantiate(fromAppStoryboard: .proposalStoryboard)
        vc.finFilterDelegate = self
...
extension FinancialStatmentsVC: ProposalListProtocolDelegate , FinFilterProtocol {
    ...
    func sendfitlerData(agentId: String, userId: String, categoryId: String, subCategoryId: String, productId: [String]) {
        ...
        let partnerId = kUserDefaults.string(forKey: "partnerID") ?? ""
        let productIdString = productId.joined(separator: ",")
        
        let param:[String: Any] = ["entityType": entityType,"entityId": partnerId, "proposalState": "POLICY_CREATED","startDate": self.startDate, "endDate": self.endDate, "pageSize": 50, "pageCount": 1,"offerType":"","agentId":agentId,"userId":userId,"categoryId":categoryId ,"subCategoryId":subCategoryId,"productId":productIdString]
        print(param)
        proposalVM.proposalListApi(param: param, showLoader: true)
    }
