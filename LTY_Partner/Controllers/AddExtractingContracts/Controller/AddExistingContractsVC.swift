...
class AddExistingContractsVC: UIViewController, ExistingContractProtocol {
    ...
    var productId = ""
    var agentId = ""
    var uploadDocArr = NSMutableArray()//[String]()
    var uploadDocArrApi = NSMutableArray()//[String]()
...
//        }
        ...
        for item in uploadDocArr{
          ...
          //  print(itemDic)
            ...
            self.uploadDocArrApi.add(dic)
        }
        
        existingContractDic["contractDoc"] = uploadDocArrApi
    ...
    @IBAction func btnTypeOfInsuranceAction(_ sender: UIButton) {
        ...
        for cat in dropDownElememnt {
            ...
            let action = UIAlertAction(title: cat.localized(), style: .default) { (action) in
                ...
                self.lblTypeOfInsurance.text = cat.localized()
