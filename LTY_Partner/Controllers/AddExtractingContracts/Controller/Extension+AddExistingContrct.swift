//
//  Extension+AddExistingContrct.swift
//  LTY_Partner
//
...
extension AddExistingContractsVC : UITextFieldDelegate  {
...
extension AddExistingContractsVC : UINavigationControllerDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate {
...
//            alert.addAction(takephoto)
    ...
    func requestNativeImageUpload(_ docName: String){
        ...
        ServerClass.sharedInstance.sendMultipartRequestToServer(urlString: fullUrl, fileName: "doc", sendJson: param, imageUrl: pickedImageUrl, successBlock: { (json) in
            ...
            if success  == "SUCCESS"
            {
                self.uploadDocArr.removeAllObjects()
...
//                    dic.setValue(OriginalFileName, forKey: "url")
                ...
                self.uploadDocArr.add(modelDic)
              //  self.uploadDocNameArr.append(docName)
